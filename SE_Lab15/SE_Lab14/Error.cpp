...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(113,"Îøèáêà ïğè ñîçäàíèè âûõîäíîãî ôàéëà ñ ğàñøèğåíèåì .out"),ERROR_ENTRY_NODEF(114),ERROR_ENTRY_NODEF(115),ERROR_ENTRY_NODEF(117),ERROR_ENTRY_NODEF(118),ERROR_ENTRY_NODEF(119),
